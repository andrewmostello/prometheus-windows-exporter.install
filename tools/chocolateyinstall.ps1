...
$packageName= 'prometheus-wmi-exporter.install' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'https://github.com/martinlindhe/wmi_exporter/releases/download/v0.2.3/wmi_exporter-0.2.3-386.msi' # download url, HTTPS preferred
$url64      = 'https://github.com/martinlindhe/wmi_exporter/releases/download/v0.2.3/wmi_exporter-0.2.3-amd64.msi' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
